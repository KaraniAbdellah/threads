...
const mockPosts = [
  {
    ...
    content: "Just finished an amazing hike in the mountains! The view from the top was absolutely breathtaking. Nature never fails to inspire me ✨",
    timestamp: "2h",
    likes: 24,
    comments: 8,
    reposts: 3
  },
  {
    ...
    content: "Working on some exciting new projects! Can't wait to share what we've been building. The future of tech is looking bright 🚀",
    timestamp: "4h",
    likes: 67,
    comments: 12,
    reposts: 8
    ...
    <div className="min-h-screen bg-gradient-to-br bg-zinc-800">
      <div className="max-w-2xl mx-auto pt-8 px-4">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-sm font-medium text-yellow-600">Everyone can reply</span>
              </div>
              ...
              <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100">
                <div className="flex space-x-4">
                  <button onClick={selectImage()} className="flex items-center space-x-2 text-blue-500 hover:bg-blue-200 px-3 py-2 rounded-full transition-colors">
                    <HiOutlinePhotograph className="w-5 h-5" />
                    <span className="text-sm font-medium">Photo</span>
                  </button>
                  <button onClick={NotBuildYet} className="flex items-center space-x-2 text-green-500 hover:bg-green-200 px-3 py-2 rounded-full transition-colors">
                    <HiOutlineVideoCamera className="w-5 h-5" />
                    <span className="text-sm font-medium">Video</span>
                  </button>
                  <button onClick={NotBuildYet} className="flex items-center space-x-2 text-yellow-500 hover:bg-yellow-200 px-3 py-2 rounded-full transition-colors">
                    <HiOutlineEmojiHappy className="w-5 h-5" />
                  </button>
                  <button onClick={NotBuildYet} className="flex items-center space-x-2 text-red-500 hover:bg-red-200 px-3 py-2 rounded-full transition-colors">
        ...
        <div className="space-y-6">
          {posts.map((post) => (
            <div key={post.id} className="bg-zinc-900 rounded-2xl shadow-lg border border-yellow-700 hover:shadow-xl transition-all duration-300">
              <div className="p-6">
                {/* Post Header */}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <h3 className="font-semibold text-yellow-600">{post.user.name}</h3>
                        {post.user.verified && (
                      ...
                      <p className="text-gray-500 text-sm">@{post.user.username} · {post.timestamp}</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <button onClick={NotBuildYet} className="flex items-center space-x-2 text-gray-500 hover:text-green-500 hover:bg-green-50 px-3 py-2 rounded-full transition-all group">
                  ...
                  <button onClick={NotBuildYet} className="flex items-center space-x-2 text-gray-500 hover:text-purple-500 hover:bg-purple-50 px-3 py-2 rounded-full transition-all group">
