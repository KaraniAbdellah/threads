...
const Profile = () => {
  ...
  return (
    <div data-aos="fade-up">
      <h3 className="text-2xl font-bold text-yellow-500 mb-2 rounded-b-md">Profile</h3>
      <p className="text-white mb-4">threads team proud of you</p>
      <div className="rounded-md">
        <div className="bg-zinc-900 overflow-hidden shadow-xl">
          ...
          {/* Cover Image Section */}
          <div className="relative h-48 bg-gradient-to-r from-yellow-700 to-yellow-500 rounded-t-md">
          ...
          {/* Profile Content */}
          <div className="relative px-6 pb-6 rounded-b-md">
            {/* Profile Image */}
            <div className="relative -mt-16 mb-4 rounded-b-md">
              ...
              <div className="flex items-center gap-3">
                {isEditing ? (
                  <input
                    ...
                    className="bg-zinc-700 rounded-b-md text-white px-3 py-2 rounded-lg border border-yellow-400 focus:border-yellow-300 focus:outline-none text-2xl font-bold"
                  />
                ) : (
